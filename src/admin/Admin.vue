...
const TAG_RULES = [
  ...
  { tag: 'Kitchen & Dining', re: /\b(kitchen|kitchenware|housewares|cooking|cookware|appliances?|dishes|plates?|glassware|pots?|pans?|utensils?|dining|bakeware|mixer|blender|microwave|espresso|cuisinart|pyrex|cast\s?iron|kitchenaid|crockpot|instant\s?pot|cookbooks?|drinkware)\b/gi },
  ...
  { tag: 'Home Decor', re: /\b(decor|lamps?|rugs?|mirrors?|lighting|linens?|pillows?|candles?|vases?|frames?|framed|ornaments?|blankets?|bedding|curtains?|drapes?|home\s?goods)\b/gi },
